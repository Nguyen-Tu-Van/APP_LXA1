...
class dethi : AppCompatActivity() {
    ...
    private fun getListQuestionDaThi3(): ArrayList<Question>? {
        val list: ArrayList<Question> = ArrayList()
        val answerList1: MutableList<Answer> = ArrayList<Answer>()
        answerList1.add(Answer("Là bộ phận của đường để ngăn cách không cho các loại xe vào những nơi không được phép.", false))
        answerList1.add(Answer("Là bộ phận của đường để phân tách phần đường xe chạy và hành lang an toàn giao thông.", false))
        answerList1.add(Answer("Là bộ phận của đường để phân chia mặt đường thành hai chiều xe chạy riêng biệt hoặc để phân chia phần đường của xe cơ giới và xe thô sơ.", true))
        answerList1.add(Answer("", false))
        val answerList2: MutableList<Answer> = ArrayList<Answer>()
        answerList2.add(Answer("Người điều khiển xe cơ giới, người điều khiển xe thô sơ.", false))
        answerList2.add(Answer("Người điều khiển xe máy chuyên dùng tham gia giao thông đường bộ.", false))
        answerList2.add(Answer("Cả ý 1 và ý 2.", true))
        answerList2.add(Answer("", false))
        val answerList3: MutableList<Answer> = ArrayList<Answer>()
        ...
        val answerList7: MutableList<Answer> = ArrayList<Answer>()
        answerList7.add(Answer("Quan sát gương, ra tín hiệu, quan sát an toàn và chuyển hướng", false))
        answerList7.add(Answer("Quan sát gương, giảm tốc độ, ra tín hiệu chuyển hướng, quan sát an toàn và chuyển hướng.", true))
        ...
        answerList8.add(Answer("", false))
        val answerList9: MutableList<Answer> = ArrayList<Answer>()
        answerList9.add(Answer("Phải đội mũ bảo hiểm đạt chuẩn, có cài quai đúng quy cách, mặc quần áo gọn gàng; không sử dụng ô, điện thoại di động, thiết bị âm thanh (trừ thiết bị trợ thính).", true))
        answerList9.add(Answer("Phải đội mũ bảo hiểm khi trời mưa gió hoặc trời quá nắng; có thể sử dụng ô, điện thoại di động, thiết bị âm thanh nhưng phải đảm bảo an toàn.", false))
        answerList9.add(Answer("Phải đội mũ bảo hiểm khi cảm thấy mất an toàn giao thông hoặc khi chuẩn bị di chuyển quãng đường xa.", false))
        answerList9.add(Answer("", false))
        val answerList10: MutableList<Answer> = ArrayList<Answer>()
        ...
        answerList11.add(Answer("Giảm tốc độ đến mức an toàn có thể và quan sát người qua đường và từ từ vượt qua xe buýt.", true))
        answerList11.add(Answer("Yêu cầu phải dừng lại phía sau xe buýt chờ xe rời bến mới đi tiếp.", false))
        answerList11.add(Answer("", false))
        val answerList12: MutableList<Answer> = ArrayList<Answer>()
        answerList12.add(Answer("Không nên đi cố vào đường hẹp; xe đi ở sườn núi nên dừng lại trước để nhường đường; khi dừng xe nhường đường phải đỗ ngay ngắn.", false))
        answerList12.add(Answer("Trong khi tránh nhau không nên đổi số; khi tránh nhau ban đêm, phải tắt đèn pha bật đèn cốt.", false))
        answerList12.add(Answer("Khi tránh nhau ban đêm, phải thường xuyên bật đèn pha tắt đèn cốt.", false))
        ...
        list.add(Question(1, "Trong các khái niệm dưới đây, “dải phân cách” được hiểu như thế nào là đúng ?", answerList1,0))
        list.add(Question(2, "Người điều khiển phương tiện tham gia giao thông đường bộ” gồm những đối tượng nào dưới đây ?", answerList2,0))
        list.add(Question(3, "Hành vi điều khiển xe cơ giới chạy quá tốc độ quy định, giành đường, vượt ẩu có bị nghiêm cấm hay không ?", answerList3,R.drawable.de3_img3))
        list.add(Question(4, "Khi điều khiển xe mô tô hai bánh, xe mô tô ba bánh, xe gắn máy, những hành vi buông cả hai tay; sử dụng xe để kéo, đẩy xe khác, vật khác; sử dụng chân chống của xe quệt xuống đường khi xe đang chạy có được phép hay không ?", answerList4,R.drawable.de3_img4))
        list.add(Question(5, "Người đủ bao nhiêu tuổi trở lên thì được điều khiển xe mô tô hai bánh, xe mô tô ba bánh có dung tích xi lanh từ 50 cm3 trở lên và các loại xe có kết cấu tương tự; xe ô tô tải, máy kéo có trọng tải dưới 3,5 tấn; xe ô tô chở người đến 9 chỗ ngồi", answerList5,0))
        list.add(Question(6, "Khi sử dụng giấy phép lái xe đã khai báo mất để điều khiển phương tiện cơ giới đường bộ, ngoài việc bị thu hồi giấy phép lái xe, chịu trách nhiệm trước pháp luật, người lái xe không được cấp giấy phép lái xe trong thời gian bao nhiêu năm ?", answerList6,0))
        list.add(Question(7, "Khi muốn chuyển hướng, người lái xe phải thực hiện như thế nào để đảm bảo an toàn giao thông ?", answerList7,0))
        list.add(Question(8, "Người điểu khiển xe mô tô hai bánh, xe gắn máy được phép chở tối đa 2 người trong những trường hợp nào ?", answerList8,0))
        list.add(Question(9, "Trong các trường hợp dưới đây, để đảm bảo an toàn khi tham gia giao thông, người lái xe mô tô cần thực hiện như thế nào ?", answerList9,0))
        list.add(Question(10, "Các phương tiện tham gia giao thông đường bộ (kể cả những xe có quyền ưu tiên) đều phải dừng lại bên phải đường của mình và trước vạch “dừng xe” tại các điểm giao cắt giữa đường bộ và đường sắt khi có báo hiệu dừng nào dưới đây ?", answerList10,0))
        list.add(Question(11, "Khi gặp xe buýt đang đang dừng đón, trả khách, người điều khiển xe mô tô phải xử lý như thế nào dưới đây để đảm bảo an toàn giao thông ?", answerList11,0))
        list.add(Question(12, "Khi tránh nhau trên đường hẹp, người lái xe cần phải chú ý những điểm nào để đảm bảo an toàn giao thông ?", answerList12,0))
        list.add(Question(13, "Để đảm bảo an toàn khi tham gia giao thông, người lái xe mô tô hai bánh cần điều khiển tay ga như thế nào trong các trường hợp dưới đây ?", answerList13,0))
        list.add(Question(14, "Biển nào cấm các phương tiện giao thông đường bộ rẽ phải ?", answerList14,R.drawable.de3_img14))
        list.add(Question(15, "Biển nào cấm tất cả các loại xe cơ giới và thô sơ đi lại trên đường, trừ xe ưu tiên theo luật định (nếu đường vẫn cho xe chạy được) ?", answerList15,R.drawable.de2_img15))
        list.add(Question(16, "Gặp biển nào người lái xe phải nhường đường cho người đi bộ ?", answerList16,R.drawable.de3_img16))
        list.add(Question(17, "Biển nào báo hiệu sắp đến chỗ giao nhau giữa đường bộ và đường sắt ?", answerList17,R.drawable.de3_img17))
        list.add(Question(18, "Biển nào báo hiệu “Đường đôi” ?", answerList18,R.drawable.de3_img18))
        list.add(Question(19, "Biển nào (đặt trước ngã ba, ngã tư) cho phép xe được rẽ sang hướng khác ?", answerList19,R.drawable.de3_img19))
        list.add(Question(20, "Biển nào chỉ dẫn cho người đi bộ sử dụng cầu vượt qua đường ?", answerList20,R.drawable.de3_img20))
